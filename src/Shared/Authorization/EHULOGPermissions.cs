...
public static class EHULOGPermissions
{
    private static readonly EHULOGPermission[] _all = new EHULOGPermission[]
    {
        ...
        new("Update Ledgers", EHULOGAction.Update, EHULOGResource.Ledgers, IsLender: true, IsLessee: false),
        ...
        new("Update LoanLenders", EHULOGAction.Update, EHULOGResource.LoanLenders, IsLender: true),
        ...
        new("View LoanProducts", EHULOGAction.View, EHULOGResource.LoanProducts, IsBasic: true, IsLender: true, IsLessee: true),
        new("Search LoanProducts", EHULOGAction.Search, EHULOGResource.LoanProducts, IsBasic: true, IsLender: true, IsLessee: true),
        new("Create LoanProducts", EHULOGAction.Create, EHULOGResource.LoanProducts, IsBasic: true, IsLender: true, IsLessee: true),
